...
@configure(
    label='[ripVT] - Report to Undetected Downloaded Samples',
    description='Parses report for downloaded samples.',
    uuids=[ 'ripVT.v2.domain_2_rep_un_downloaded_samples'],
...
def dotransform(request, response):
    ...
    try:
        items=ast.literal_eval(request.fields['undetected_downloaded_samples'])
    except:
        return response
